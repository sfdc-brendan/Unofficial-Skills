...
# ============================================================
# Agentforce Contact Center — skill installer
#
# One-line install:
#
...
BRANCH="main"
PACK_PATH="agentforce/contact-center"
...
echo ""
echo "==========================================="
echo " Agentforce Contact Center installer"
echo " Native Salesforce Voice, IVR, callbacks, Command Center"
echo "==========================================="
echo ""
...
if [ "$installed" -gt 0 ]; then
  ...
  echo ""
  echo "Then try: Plan the end-to-end build for an Agentforce Contact Center voice agent."
fi
