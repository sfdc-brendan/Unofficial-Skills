...
# ============================================================
# Agentforce (all packs) — skill installer
#
# One-line install:
#
# curl -sSL https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/agentforce/install.sh | bash
#
# wget -qO- https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/agentforce/install.sh | bash
#
...
echo ""
echo "==========================================="
echo " Agentforce (all packs) installer"
echo " Agent API + Vision + Contact Center"
echo "==========================================="
echo ""
...
if [ "$installed" -gt 0 ]; then
  ...
  echo ""
  echo "Then try: Set up Agent API auth, then connect an Agentforce Voice agent to native telephony."
fi
