...
# ============================================================
# Agentforce Agent API — skill installer
#
# One-line install:
#
# curl -sSL https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/agentforce/agent-api/install.sh | bash
#
# wget -qO- https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/agentforce/agent-api/install.sh | bash
#
...
BRANCH="main"
PACK_PATH="agentforce/agent-api"
...
echo ""
echo "==========================================="
echo " Agentforce Agent API installer"
echo " Agent API setup, sessions, messaging, variables, citations"
echo "==========================================="
echo ""
...
if [ "$installed" -gt 0 ]; then
  ...
  echo ""
  echo "Then try: Set up an External Client App and mint a token for the Agent API."
fi
