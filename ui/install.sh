...
# ============================================================
# UI (all packs) — skill installer
#
# One-line install:
#
# curl -sSL https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/ui/install.sh | bash
#
# wget -qO- https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/ui/install.sh | bash
#
...
echo ""
echo "==========================================="
echo " UI (all packs) installer"
echo " Lightning Web Component UI/UX skills"
echo "==========================================="
echo ""
...
if [ "$installed" -gt 0 ]; then
  ...
  echo ""
  echo "Then try: Review this LWC for design quality and accessibility."
fi
