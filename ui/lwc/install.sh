...
echo ""
echo "==========================================="
echo " LWC UI/UX installer"
echo " SLDS 2 design, UX, theming, motion, mobile, review"
echo "==========================================="
echo ""
...
if [ "$installed" -gt 0 ]; then
  ...
  echo ""
  echo "Then try: Create an LWC card component that's SLDS 2 compliant."
fi
