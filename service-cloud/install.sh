...
# ============================================================
# Service Cloud (all packs) — skill installer
#
# One-line install:
#
# curl -sSL https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/service-cloud/install.sh | bash
#
# wget -qO- https://raw.githubusercontent.com/sfdc-brendan/Unofficial-Skills/main/service-cloud/install.sh | bash
#
...
echo ""
echo "==========================================="
echo " Service Cloud (all packs) installer"
echo " Service Cloud core + Field Service"
echo "==========================================="
echo ""
...
if [ "$installed" -gt 0 ]; then
  ...
  echo ""
  echo "Then try: Design a case-to-field-service dispatch handoff with SLA milestones."
fi
