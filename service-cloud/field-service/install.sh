...
BRANCH="main"
PACK_PATH="service-cloud/field-service"
...
echo ""
echo "==========================================="
echo " Field Service installer"
echo " Work orders, scheduling, mobile technician, inventory"
echo "==========================================="
echo ""
...
if [ "$installed" -gt 0 ]; then
  ...
  echo ""
  echo "Then try: Design a scheduling and dispatch model for multi-region field teams."
fi
